...
@Component({
  selector: 'app-admin-encuesta2',
  templateUrl: './admin-encuesta2.component.html',
  styleUrls: ['./admin-encuesta2.component.less']
})
export class AdminEncuesta2Component implements OnInit {
  ...
  public async postEncuesta2() { 
    ...
    try {
      ...
      alert("Error al añadir la encuesta 2");
    } 
  }
