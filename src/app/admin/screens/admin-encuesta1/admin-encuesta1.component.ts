...
@Component({
  selector: 'app-admin-encuesta1',
  templateUrl: './admin-encuesta1.component.html',
  styleUrls: ['./admin-encuesta1.component.less']
})
export class AdminEncuesta1Component implements OnInit {
