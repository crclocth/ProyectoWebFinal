...
@Component({
  selector: 'app-user-encuesta3',
  templateUrl: './user-encuesta3.component.html',
  styleUrls: ['./user-encuesta3.component.less']
})
export class UserEncuesta3Component implements OnInit {
