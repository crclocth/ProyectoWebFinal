...
@Component({
  selector: 'app-user-encuesta2',
  templateUrl: './user-encuesta2.component.html',
  styleUrls: ['./user-encuesta2.component.less']
})
export class UserEncuesta2Component implements OnInit {
